# Sleep Artifact Patterns

These are recommended output shapes for `sleep`.

They are not a mandatory ontology. Use them to keep artifacts legible and consistent while preserving local judgment.
...
Use when one note needs a clearer entry point.

Possible sections:

- what this note is about
- why it matters
- key claims, ideas, or moving parts
- related notes
...
Use when several notes form a dense region and the main comprehension gap is relational.

Possible sections:

- scope of the cluster
- why this region matters
- core notes or anchors
- major relationships, agreements, or tensions
- entry points for future reading
- known gaps or unresolved edges

A cluster overview should help a future reader decide where to enter and what to read next.

## Relationship Enrichment Pattern

Use only for high-confidence links.
...
## Choosing The Smallest Useful Artifact

Prefer the smallest artifact that solves the comprehension problem:
