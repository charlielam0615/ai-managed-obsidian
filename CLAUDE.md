...
- Paper or PDF ingestion: use `System/Skills/paper-ingestion/SKILL.md`.
...
- Broad questions: whether `Notes/Index.md` was consulted, whether retrieval was translated into English when relevant, the main note anchors, and whether raw PDFs were needed.
