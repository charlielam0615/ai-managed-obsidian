...
No synthesis notes yet.

## Open Questions

- When should the vault split `Notes/` into a small number of functional subfolders, if ever?
- When does the note layer outgrow manual indexing and justify local search tooling such as `qmd`?
